...
echo "Creating firestore credentials for GKE..."
...
echo "Enabling necessary APIs. May take little longer as container.googleapis.com takes about a minute to apply..."
